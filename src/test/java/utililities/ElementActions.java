...
public class ElementActions {
    public static void clickOnElementInAList(List<AndroidElement> elements, String text){
    ...
    static int waitOptionsDuration = Integer.parseInt(ConfigReader.getProperty("implicitWait"));
